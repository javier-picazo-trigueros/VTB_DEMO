        ...
        >
          {success ? (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center">
              ...
              <h2 className="text-xl font-bold text-green-600 dark:text-green-400 mb-2">Password changed!</h2>
              <p className="text-slate-500 dark:text-slate-400 text-sm">Redirecting to dashboard…</p>
            </motion.div>
          ) : (
            <>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Change Password</h2>
              <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">Enter your current password and choose a new one.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input type="password" name="next" value={form.next} onChange={handleChange} disabled={loading} className={inputCls} placeholder="Min. 6 characters" required />
                </div>
                <div>
