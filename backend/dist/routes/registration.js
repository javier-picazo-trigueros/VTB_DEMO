...
router.post("/request", async (req, res) => {
    try {
        ...
        const result = await db.exec(`INSERT INTO registration_requests (full_name, email, student_id, status, created_at)
       VALUES (?, ?, ?, 'pending', CURRENT_TIMESTAMP)`, [fullName, email, studentId]);
        res.json({
